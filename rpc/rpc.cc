		...
		unsigned int xid_rep, char **b, int *sz)
{
	...
	{
		std::list<reply_t> toAdd = std::list<reply_t>();
		reply_window_[clt_nonce] = toAdd;
	}

	unsigned int min = 65535;
	bool hasMin = reply_window_[clt_nonce].size() > 0;
